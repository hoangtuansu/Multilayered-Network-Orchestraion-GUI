...
export const G2DNOs: GNObject2D[] = [
  ...
  assets_path + 'world-data-center.png', 
  assets_path + 'world-data-center-hover.png', 
  assets_path + 'world-data-center-selected.png', [36, 36], [-118, 56], ['1', '2', '3']),
  new GNObject2D ('gnobject2d3', 'mdc', 'Montreal DC', NODE_LEVEL.COUNTRY, 
  assets_path + 'world-data-center.png', 
  assets_path + 'world-data-center-hover.png', 
  assets_path + 'world-data-center-selected.png', [36, 36], [-78, 60], ['1', '2', '3']),
  ...
  assets_path + 'country-switch-selected.png', [20, 20], [-140, 65], ['1', '2', '3']),
  new GNObject2D ('gnobject2d5', 'cco', 'Calgary CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-118, 54], ['1', '2', '3']),
  new GNObject2D ('gnobject2d6', 'sco', 'Saskatoon CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-109, 56], ['1', '2', '3']),
  new GNObject2D ('gnobject2d7', 'chco', 'Churchill CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-100, 59], ['1', '2', '3']),
  new GNObject2D ('gnobject2d8', 'vco', 'Vancouver CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-128, 58], ['1', '2', '3']),
  new GNObject2D ('gnobject2d9', 'ico', 'Inuvik CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-130, 69], ['1', '2', '3']),
  new GNObject2D ('gnobject2d10', 'tco', 'ThunderBay CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-90, 52], ['1', '2', '3']),
  new GNObject2D ('gnobject2d11', 'mco', 'Montreal CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-78, 50], ['1', '2', '3']),
  new GNObject2D ('gnobject2d12', 'lco', 'Laval CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-75, 57], ['1', '2', '3']),
  new GNObject2D ('gnobject2d13', 'rco', 'Rankin CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-100, 65], ['1', '2', '3']),
  new GNObject2D ('gnobject2d14', 'fco', 'Fort CO', NODE_LEVEL.STATE, 
  assets_path + 'country-switch.png', 
  assets_path + 'country-switch-hover.png', 
  assets_path + 'country-switch-selected.png', [20, 20], [-115, 64], ['1', '2', '3']),
  new GNObject2D ('gnobject2d15', 'bbn', 'Buffalo Net', NODE_LEVEL.CITY, 
  assets_path + 'router.png', 
  assets_path + 'router-hover.png', 
  assets_path + 'router-selected.png', [6, 6], [-113, 55], ['1', '2', '3']),
  new GNObject2D ('gnobject2d16', 'edn', 'Edmonton Net', NODE_LEVEL.CITY, 
  assets_path + 'router.png', 
  assets_path + 'router-hover.png', 
  assets_path + 'router-selected.png', [6, 6], [-117, 53], ['1', '2', '3']),
  new GNObject2D ('gnobject2d17', 'can', 'Calgary Net', NODE_LEVEL.CITY, 
  assets_path + 'router.png', 
  assets_path + 'router-hover.png', 
  assets_path + 'router-selected.png', [6, 6], [-115, 59], ['1', '2', '3']),

  new GNObject2D ('gnobject2d18', 'odc', 'Ontario DC', NODE_LEVEL.COUNTRY, 
  assets_path + 'world-data-center.png', 
  assets_path + 'world-data-center-hover.png', 
  assets_path + 'world-data-center-selected.png', [36, 36], [-98, 55], ['1', '2', '3']),
];
